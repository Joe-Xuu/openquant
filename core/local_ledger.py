...
CHART_OF_ACCOUNTS: Dict[str, Dict[str, Any]] = {
    ...
    "CASH-DOGE": {"name": "DOGE Cash Balance", "type": AccountType.ASSET, "normal_balance": NormalBalance.DEBIT, "currency": "DOGE"},
    ...
    "POS-DOGEUSDT": {"name": "DOGE/USDT Open Position", "type": AccountType.ASSET, "normal_balance": NormalBalance.DEBIT, "currency": "DOGE"},
